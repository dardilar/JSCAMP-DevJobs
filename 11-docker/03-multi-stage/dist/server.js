...
// node_modules/.pnpm/canvas-confetti@1.9.3/node_modules/canvas-confetti/src/confetti.js
var require_confetti = __commonJS({
  "node_modules/.pnpm/canvas-confetti@1.9.3/node_modules/canvas-confetti/src/confetti.js"(exports, module) {
...
// src/server.js
var import_canvas_confetti = __toESM(require_confetti(), 1);
...
createServer((req, res) => {
  ...
  res.end(
    JSON.stringify({
      mensaje: "Imagen m\xEDnima creada con multi-stage build \u{1F433}",
      nota: "Esta imagen final NO contiene esbuild ni el c\xF3digo fuente sin compilar",
      ejemploDependency: "Hemos importado canvas-confetti con \xE9xito en producci\xF3n, pero esbuild (devDependencies) se qued\xF3 fuera."
    })
  );
}).listen(PORT, () => {
  console.log(`\u{1F680} Servidor (multi-stage) escuchando en el puerto ${PORT}`);
});
